...
import Contacts from '../../domain/contacts/database/contacts-seeder'

export default Marionette.Object.extend({

    initialize: function() {
        this.data = {
            contacts: (new Contacts).seed()
        };
    },
...
//export default directory.MemoryStore = function (successCallback, errorCallback) {
//
